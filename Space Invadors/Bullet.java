...
public class Bullet extends JPanel {
   ...
   int x, y; // x and y are coordinates and whoShoots is to determine if it's the player or enemy 
   int  whoShoot;
   
	/**
	 * The constractor of the Bullet class, initializes the variables to a standard input
	 * 
